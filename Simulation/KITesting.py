...
# 可调整参数
inputPath = "D:\\Code\\genschema\\Simulation\\KIdir\\"
outputPath = "D:\\Code\\genschema\\aoutput\\ki.txt"
    ...
    if file.endswith(".cir"):
        ...
        try:
            ...
            if first_sim_success and second_sim_success:
                ...
                print(f"{file}.cir simulation failed and {file}.cir ki simulation failed")
                with open(outputPath, "a", encoding='utf-8') as outputFile:
