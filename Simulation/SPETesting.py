...
# 可调整参数
inputPath = "D:\\Code\\Simulation\\SPEdir\\"
outputPath = "D:\\Code\\genschema\\aoutput\\spe.txt"
    ...
    if file.endswith(".cir"):
        ...
        try:
            ...
            if first_sim_success and second_sim_success:
                ...
                print(f"{file}.cir simulation failed and {file}.cir spe simulation failed")
                with open(outputPath, "a", encoding='utf-8') as outputFile:
...
# 可调整参数
inputPath = "D:\\Code\\PCBSmith+\\PCBSmith+\\genschema\\SPEdir\\"
outputPath = "D:\\Code\\PCBSmith+\\PCBSmith+\\genschema\\aoutput\\20250313_7.txt"
