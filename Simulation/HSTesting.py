...
# 可调整参数
inputPath = "D:\\Code\\genschema\\Simulation\\HSdir\\"
outputPath = "D:\\Code\\genschema\\aoutput\\hs.txt"
    ...
    if file.endswith(".cir"):
        ...
        try:
            ...
            if first_sim_success and second_sim_success:
                ...
                print(f"{file}.cir simulation failed and {file}.cir hs simulation failed")
                with open(outputPath, "a", encoding='utf-8') as outputFile:
